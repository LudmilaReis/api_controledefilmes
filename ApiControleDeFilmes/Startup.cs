using ApiControleDeFilmes.Controllers.V1;
...
namespace ApiControleDeFilmes
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IFilmeRepository, FilmeSqlServerRepository>();
            services.AddScoped<IEspectadorService, EspectadorService>();
            services.AddScoped<IEspectadorRepository, EspectadorSqlServerRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ApiControleDeFilmes", Version = "v1" });
